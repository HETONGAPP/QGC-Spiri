...
public:
    ...
    Q_PROPERTY(QmlObjectListModel*      trajectoryCreators            MEMBER _trajectoryCreators                        NOTIFY trajectoryCreatorsChanged)
...
signals:
    ...
    void trajectoryCreatorsChanged          (QmlObjectListModel* trajectoryCreators);
...
private slots:
    ...
    void _updateTrajectoryCreatorsList    (void);
...
private:
    ...
    QmlObjectListModel*     _trajectoryCreators =       nullptr;
};
