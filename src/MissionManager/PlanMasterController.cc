...
void PlanMasterController::_commonInit(void)
{
    ...
    connect(_controllerVehicle,     &Vehicle::vehicleTypeChanged,                   this, &PlanMasterController::_updateTrajectoryCreatorsList);
}
...
void PlanMasterController::_updateTrajectoryCreatorsList(void)
{
    if (!_trajectoryCreators)
    {
        _trajectoryCreators = new QmlObjectListModel(this);
        _trajectoryCreators->append(new CircleCreator(this, this));
        _trajectoryCreators->append(new HelixCreator(this, this));
        _trajectoryCreators->append(new RectangleCreator(this, this));
        _trajectoryCreators->append(new LemniscatelCreator(this,this));
        emit trajectoryCreatorsChanged(_trajectoryCreators);
    }
}
...
void PlanMasterController::_updatePlanCreatorsList(void)
{
    //if (!_flyView) {
        if (!_planCreators) {
            ...
            _planCreators->append(new WaterSamplingPlanCreator(this, this));
