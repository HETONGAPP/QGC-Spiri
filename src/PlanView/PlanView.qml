...
Item {
    ...
    property bool _triggerFly: true
    property bool _triggerPlan: true
    ...
    property var    _missionController1:                 _planController.missionController
    property var    _geoFenceController1:                _planController.geoFenceController
    property var    _rallyPointController1:              _planController.rallyPointController
    ...
    GuidedActionsController {
        ...
        missionController:  _missionController1
...
*/
    ...
    Item {
        ...
        ToolStrip {
            ...
            maxHeight:          parent.height - toolStrip1.y
            title:              qsTr("Fly")
            visible: true
            ...
            ToolStripActionList {
                ...
                model: [
                    ToolStripAction {
                        ...
                        onTriggered:    {
                            //_triggerFly = _triggerFly  ? false :true
                    ...
                    GuidedActionLand { visible:    _triggerFly},
                    GuidedActionRTL { visible:    _triggerFly},
                    GuidedActionPause { visible:    _triggerFly},
                    GuidedActionActionList { visible:    _triggerFly},
                    ToolStripAction {
                        id:control
                        text:           qsTr("Release")
            ...
            ToolStripActionList {
                ...
                model: [
                    ToolStripAction {
                        ...
                        onTriggered:    {
                            _triggerPlan = _triggerPlan  ? false :true
                            _triggerPlan ? fileDrop.dropPanelComponent = syncDropPanel:fileDrop.dropPanelComponent = syncDropPanelVoid
                    ...
                    ToolStripAction {
                        ...
                        visible:                _triggerPlan
                        showAlternateIcon:      _planMasterController.dirty
                        iconSource:             "/qmlimages/MapSync.svg"
                        alternateIconSource:    "/qmlimages/MapSyncChanged.svg"
                        onTriggered:  fileDrop.dropPanelComponent = syncDropPanel
                    },
                    ToolStripAction {
                        id : trajectoryDrop
                        ...
                        visible:                _triggerPlan
                        showAlternateIcon:      _planMasterController.dirty
                        iconSource:             "/res/resources/icons/trajectory.png"
                        onTriggered:  trajectoryDrop.dropPanelComponent = trajectoryActions
                    },
                    ToolStripAction {
                        text:       qsTr("Takeoff")
                        iconSource: "/res/takeoff.svg"
                        enabled:    _missionController.isInsertTakeoffValid
                        visible:    _triggerPlan&&toolStrip._isMissionLayer && !_planMasterController.controllerVehicle.rover
                        onTriggered: {
                    ...
                    ToolStripAction {
                        ...
                        visible:            _triggerPlan&&toolStrip._isMissionLayer && _planMasterController.controllerVehicle.roiModeSupported
                    ...
                    ToolStripAction {
                        ...
                        visible:            _triggerPlan&&toolStrip._isMissionLayer
...
//                    }
    ...
    Component {id: syncDropPanelVoid
        Image {
            id:                 planCreatorImage1
            /*anchors.left:       parent.left
            anchors.right:      parent.right
    ...
    Component {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                Repeater {
                    model: _planMasterController.trajectoryCreators
