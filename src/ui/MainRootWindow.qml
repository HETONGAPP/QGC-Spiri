...
ApplicationWindow {
    ...
    property int currentView : toolbar.currentToolbar
    ...
    function viewSwitchA(currentToolbar) {
    ...
    function showSetupTool() {
        showTool(qsTr("Spiri Setup"), "SetupView.qml", "/qmlimages/Gears.svg")
    }

    function showSettingsTool() {
        showTool(qsTr("Application Settings"), "AppSettings.qml", "/res/pencil.svg")
    }
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    SubMenuButton {
                        ...
                        imageResource:      "/res/resources/icons/Spiri_black_120.ico"
