...
Rectangle {
    ...
    property string fieldColor:"#FFFFFF"
    property string buttonToggledDownColor: Qt.darker(fieldColor)
    ...
    Rectangle {
        ...
        gradient: Gradient {
            ...
            GradientStop { position: 0;                                     color: "#ff6347" }
            GradientStop { position: currentButton.x + currentButton.width; color: "#ff6347" }
    ...
    Rectangle {
        ...
        gradient: Gradient {
            orientation: Gradient.Horizontal
            GradientStop { position: 1;                                     color: "#ff6347" }
    ...
    RowLayout {
        ...
        QGCToolBarButton {
            ...
            icon.source:            "/res/resources/icons/Spiri_black_120.ico"
            logo:                   true
    ...
    Button {
        ...
        style: ButtonStyle {
            ...
            label: Rectangle {
                ...
                Image {
                    id: settingsImage3
                    source: "/qmlimages/topbar_gear_white.png"
                    width: 35
                    height: 35
                    anchors.verticalCenter: parent.verticalCenter
                } // Image
                ...
                ColorOverlay {
                    source: settingsImage3
                    anchors.fill: settingsImage3
                    //color: settingsDialog.shown ? buttonToggledDownColor : buttonToggledUpColor
                    color: buttonToggledDownColor
                }
            } // label: Rectangle
        } // style: ButtonStyle
